...
bool umesh_is_initialized(void) { return g_um_state.initialized; }
...
uint8_t umesh_get_mode(void) { return (uint8_t)umesh_mm_get_mode(); }
...
uint16_t umesh_get_meshnetid(void) { return umesh_mm_get_meshnetid(NULL); }

uint16_t umesh_get_meshnetsize(void) { return umesh_mm_get_meshnetsize(); }

uint16_t umesh_get_sid(void) { return umesh_mm_get_local_sid(); }
